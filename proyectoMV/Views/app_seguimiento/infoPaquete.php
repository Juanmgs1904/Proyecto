...
$codigo = $_POST['codigo'];
$url = "localhost/Controller/transito/C_paquetes.php?codigo=$codigo";
...
<body class="fondo">
    ...
    ?>
        ...
        ?>
        <?php
        $url = "localhost/Controller/transito/C_lotesP.php?codigo=$codigo";
        require("../../intermediario/getDataAPI.php");
        if (!empty($array)) {
        ?>
            <div class="tabla__contenedor">
            ...
            <?php
            $url = "localhost/Controller/transito/C_camionP.php?IDL=$IDL";
            require("../../intermediario/getDataAPI.php");
            if (!empty($array)) {
            ?>
                <div class="tabla__contenedor">
                ...
                <?php
                $url = "localhost/Controller/transito/C_choferP.php?Matricula=$matricula";
                require("../../intermediario/getDataAPI.php");
                if (!empty($array)) {
                ?>
                    <div class="tabla__contenedor">
                    ...
                    <?php
                    $url = "localhost/Controller/transito/C_camionetasP.php?codigo=$codigo";
                    require("../../intermediario/getDataAPI.php");
                    if (!empty($array)) {
                    ?>
                        <div class="tabla__contenedor">
