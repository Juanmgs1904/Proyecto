...
$url = 'localhost/Controller/almacen/C_asignarLote.php?matricula=' . $matricula . '';
...
<body class="fondo">
    ...
    <div class="tabla__contenedor">
        ...
        <div class="LEC_grid">
            ...
            ?>
                    ...
                    <div class="datos">
                        <?php
                        echo '<a href="#" onclick="confirmDelete(\''  . $fila['IDL'] . '\', \'' . $matricula . '\', \'' . $idA . '\');">' . '<div class="option" data-section="lotesAR" data-value="eliminar">Eliminar</div>'  . ' </a>';
                        ?>
                        <script>
    ...
    <div class="btn_volver">
        <?php echo '<a href="tabla_asignarLAC.php?idA=' . $idA . '" class="btn" data-section="lotesC" data-value="btnV">'; ?>Volver</a>
    </div>
