...
class asignarPALE extends conexion {

    private $codigo = "";
    private $IDL = "";

    public function listaPAL($empresa){
        $sentencia1 = "SELECT IDL FROM lotes WHERE Estado = 'noAsignado' AND enAlmacenExterno = 1 AND Empresa = '$empresa'";
        $sentencia = "SELECT codigo, IDL FROM contiene WHERE IDL IN ($sentencia1)";
