...
while true; do
	...
	case $eleccion in
		1)
		clear
		confirmar_operacion && exeWho
		;;
		2)
		clear
		confirmar_operacion && exeW
		;;
		3)
		clear
		confirmar_operacion && exeLast
		;;
		4)
		clear
		confirmar_operacion && exeLast_n
		;;
		5)
		clear
		confirmar_operacion && exeLastLog
		;;
		6)
		clear
		confirmar_operacion && exeLastB
		;;
		0)
		clear
