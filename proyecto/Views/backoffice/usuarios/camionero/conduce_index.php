...
<body>
    ...
    <header class="header">
        ...
        <div class="info_tabla">
            <div class="tabla">
                <div class="grid2">
                    ...
                    <div class="datos pFila" data-section="vehiculo" data-value="matricula">Matricula</div>
                    ...
                    ?>
                            ...
                            <div class="datos">
                                <?php
                                echo '<a href="camioneroAC.php?matriculaV=' . $fila['MatriculaV'] . '"data-section="camionero" data-value="op">Ver Camionero</a>';
                                ?>
                            </div>
                    <?php
                        }
        ...
        <div class="btn_tabla">
            <a class="btn" href="conduce_agregar.php" data-section="boton" data-value="volver">Volver</a>
        </div>
    </div>
