...
<header class="header">
    ...
    <div class="tabla__contenedor">
        ...
        <div class="grid_llegada">
            ...
            ?>
                ...
                <div class="datos">
                    <?php                           
                    echo '<a href="#" onclick="confirmDelete(\''  . $fila['Matricula'] . '\', \'' . $empresa . '\', \'' . $fila["FechaLlegada"] . '\');">' . '<div class="option">Eliminar</div>' . ' </a>';
                    ?>
                    <script>
                        function confirmDelete(matricula, empresa, FechaLlegada) {
                            var confirmation = confirm("¿Estás seguro de que deseas eliminar esta hora de llegada de un camión?");
                            if (confirmation) {
                                // Si el usuario confirma, redirige a la página de eliminación
                                window.location.href = "../../../../intermediario/deleteDataAPI.php?matricula=" + matricula + "&empresa=" + Iempresa+ "&fechaLlegada="+ FechaLlegada;
                            }
                        }
                    </script>
                </div>
    ...
    <div class="btn_volver">
        <?php echo '<a href="../llegadaAE.php?empresa='.$empresa.'" class="btn">'; ?>Volver</a>
    </div>
</body>
