...
<header class="header">
    ...
    <div class="tabla__contenedor">
        ...
        <div class="LEC_grid">
            ...
            ?>
                    ...
                    <div class="datos">
                        <?php         
                        echo '<a href="#" onclick="confirmDelete(\''  . $fila['IDL'] . '\', \'' . $matricula . '\', \'' . $empresa . '\');">' . '<div class="option">Eliminar</div>'  . ' </a>';
                        ?>
                        <script>
    ...
    <div class="btn_volver">
        <?php echo '<a href="tabla_asignarLACE.php?empresa='.$empresa.'" class="btn">'; ?>Volver</a>
    </div>
</body>
